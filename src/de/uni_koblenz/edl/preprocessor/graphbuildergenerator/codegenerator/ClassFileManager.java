...
public class ClassFileManager extends
	...
	private InMemoryClassFile outputFile;

	public ClassFileManager(JavaFileManager fm, String outputPath) {
		super(fm);
	}
	...
	public JavaFileObject getJavaFileForOutput(Location location,
		...
		outputFile = cfa;
		SchemaClassManager.instance(className).putSchemaClass(className, cfa);
	...
	public InMemoryClassFile getOutputFile() {
		return outputFile;
	}
}
